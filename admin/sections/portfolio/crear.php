...
if($_POST){
  ...
  $sentencia=$conexion->prepare("INSERT INTO `tbl_portafolio` (`id`, `imagen`, `titulo`, `subitulo`, `descripcion`, `cliente`, `categoria`, `url`) VALUES (NULL, :imagen, :titulo, :subitulo, :descripcion, :cliente, :categoria, :url);");
  
  $sentencia->bindParam(":imagen",$nombre_archivo_imagen);
  $sentencia->bindParam(":titulo",$titulo);
  $sentencia->bindParam(":subitulo",$subTitulo);
