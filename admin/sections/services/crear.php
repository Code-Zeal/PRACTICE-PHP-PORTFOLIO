...
<div class="mb-3">
  <label for="icono" class="form-label">Icono <a name="verIconos" id="verIconos" class="btn btn-primary " href="https://fontawesome.com/v4/icons/" target="_blank" rel="noopener" role="button">Ver Iconos (fa)</a></label>
  <input type="text"
